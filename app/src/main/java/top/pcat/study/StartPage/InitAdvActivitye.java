...
public class InitAdvActivitye extends BaseActivitye {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (i < 5) {
            ...
            startActivity(new Intent(InitAdvActivitye.this, MainActivity.class));
            finish();
        }
    }
    ...
    private void initView2() {
        ...
        View view = View.inflate(InitAdvActivitye.this, picsLayout[i], null);
